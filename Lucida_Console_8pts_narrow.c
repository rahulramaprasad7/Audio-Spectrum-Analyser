/*
 * @file Lucida_Console_8pts_narrow.c
 * @brief The font data to display on the LCD
 *
 * This source file contains the bitmap for
 * each printable ascii character, which along
 * with it's offset is used to display a
